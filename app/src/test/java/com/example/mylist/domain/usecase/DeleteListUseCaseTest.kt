...
import com.example.mylist.data.fake.FakeItemListRepository
...
class DeleteListUseCaseTest {
    ...
    private lateinit var listRepository: FakeItemListRepository
    ...
    @Before
    fun setup() {
        listRepository = FakeItemListRepository()
